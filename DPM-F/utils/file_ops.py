...
def setup_log(args):    
    ...
    if args.log_directory == '':
        ...
        args.log_directory = os.path.join('log',time_str)+'.log'
    else:
        args.log_directory = os.path.join('log', args.log_directory) + '.log'
    fileHandler = logging.FileHandler(args.log_directory, mode='w')
